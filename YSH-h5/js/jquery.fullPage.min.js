    ...
    c.fn.fullpage = function (d) {
        function La() {
            ...
            c(".fp-section").each(function (a) {
                var b = c(this), e = b.find(".fp-slide"), h = e.length;
        ...
        function oa() {
            ...
            if (!d.autoScrolling || d.scrollBar) {
                if (!a.hasClass("active") && !a.hasClass("fp-auto-height")) {
                    ...
                    if (l.length)var r = l.data("anchor"), q = l.index();
        ...
        function L(a, b) {
            if (k.m[a]) {
                ...
                if (0 < b.length)if (d = "top" === d ? !b.scrollTop() : "bottom" === d ? b.scrollTop() + 1 + b.innerHeight() >=
        ...
        function xa() {
            if (!W && !d.lockAnchors) {
                ...
                if (b.length) {
                    var c = "undefined" === typeof A, f = "undefined" === typeof A && "undefined" === typeof a && !z;
        ...
        function F(a, b) {
            var g = b.position(), f = b.index(), e = a.closest(".fp-section"), h = e.index(".fp-section"), k = e.data("anchor"), l = e.find(".fp-slidesNav"),
                m = ya(b), n = v;
            if (d.onSlideLeave) {
                var r = e.find(".fp-slide.active"), q = r.index(), t;
        ...
        function ma() {
            var a = c(".fp-section.active"), b = a.find(".fp-slide.active"), e = a.data("anchor"), f = ya(b), a = a.index(".fp-section"), a = String(a);
            d.anchors.length &&
            (a = e);
            b.length && (a = a + "-" + f);
            a = a.replace("/", "-").replace("#", "");
        ...
        var t = c("html, body"), r = c("body"), e = c.fn.fullpage;
        d = c.extend({
            menu: !1,
            anchors: [],
            lockAnchors: !1,
        ...
        var z = !1, Q = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/),
            R = "ontouchstart" in l || 0 < navigator.msMaxTouchPoints || navigator.maxTouchPoints, h = c(this), q = n.height(), v = !1, Ja = !0, A, ea, y = !0, C = [], O, k = {
                m: {
                    up: !0,
                    down: !0,
                    left: !0,
        ...
        k.k = c.extend(!0, {}, k.m);
        var G = c.extend(!0, {}, d), ha, ca, fa, Z, aa, Ka;
        c(this).length && La();
        var W = !1;
        n.on("scroll", oa);
        var E = 0, N = 0, D = 0, M = 0, ta = (new Date).getTime();
...
/*  |xGv00|e95c00999521ec5648b594ca0101f22b */